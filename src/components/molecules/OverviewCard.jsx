...
const OverviewCard = ({
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 sm:p-5 border border-gray-100 bg-[#F8FAFC]/50 rounded-2xl transition-all hover:bg-white hover:shadow-sm">
        ...
        <button
          ...
          className={clsx(
            ...
            isActive ? "bg-[#2E60F6]" : "bg-[var(--color-gray-300)]"
          )}
        >
          <span
            className={clsx(
              "inline-block h-4 w-4 sm:h-5 sm:w-5 transform rounded-full bg-[var(--color-white)] transition-transform duration-200 shadow-sm",
  ...
  return (
    <div className="w-full bg-[var(--color-white)] border border-gray-200 rounded-xl p-4 sm:p-5 shadow-sm">
