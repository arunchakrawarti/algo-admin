...
const ManageBroker = () => {
  ...
  return (
    <div className="w-full space-y-6 mt-5">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {brokers.map((broker, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center p-6 rounded-xl border border-gray-100 bg-white hover:border-gray-300 hover:shadow-md transition-all cursor-pointer group"
            >
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm py-20 px-4 flex flex-col items-center justify-center text-center">
        <div className="relative mb-6">
          <div className="absolute inset-0 bg-blue-100 blur-xl opacity-50 rounded-full"></div>
          <div className="relative w-16 h-16 bg-[#eef2ff] rounded-full flex items-center justify-center border border-blue-100">
